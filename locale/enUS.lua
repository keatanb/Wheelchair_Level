...
L["MainDescription"] = "A simple addon that provides details about the kills, quests, dungeons and time required to gain a level."
L["Max"] = "Max"
...
L["Show WheelchairLevel Header"] = "Show WheelchairLevel Header"
